...
final class CreateSupplierProductFlowTest extends WebTestCase
{
    ...
    public function testSuccessfulCreationViaForm(): void
    {
        ...
        $this->browser()
            ...
            ->fillField('supplier_product[category]', $category->getId())
            ->click('supplier_product_auto-update')
            ->fillField('supplier_product[subcategory]', $subcategory->getId())
            ->fillField('supplier_product[manufacturer]', $manufacturer->getId())
            ...
            ->fillField('supplier_product[product]', $product->getId())
