...
class SupplierSubcategoryIntegrationTest extends KernelTestCase
{
    ...
    public function testSupplierCategoryIsRequired(): void
    {
        $supplierSubcategory = SupplierSubcategoryFactory::new()->withoutPersisting()->create(['supplierCategory' => null]);

        $violations = $this->validator->validate($supplierSubcategory);
        $this->assertSame('Please enter a supplier category', $violations[0]->getMessage());
    }
