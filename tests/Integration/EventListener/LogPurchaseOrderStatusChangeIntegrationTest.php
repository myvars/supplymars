...
class LogPurchaseOrderStatusChangeIntegrationTest extends KernelTestCase
{
    use Factories;
    ...
    public function testOnOrderItemStatusChangeLogsStatusChange(): void
    {
        ...
        $purchaseOrderStatusChangeLog = StatusChangeLogFactory::repository()->findOneBy([
            'eventTypeId' => $purchaseOrderItem->getPurchaseOrder()->getId(),
            'eventType' => DomainEventType::PURCHASE_ORDER_STATUS_CHANGED,
            'status' => PurchaseOrderStatus::PROCESSING

        ]);

        $this->assertNotNull($purchaseOrderStatusChangeLog);
    }
}