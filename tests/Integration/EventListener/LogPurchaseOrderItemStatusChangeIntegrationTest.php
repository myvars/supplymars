...
class LogPurchaseOrderItemStatusChangeIntegrationTest extends KernelTestCase
{
    use Factories;
    ...
    public function testOnOrderItemStatusChangeLogsStatusChange(): void
    {
        ...
        $purchaseOrderItemStatusChangeLog = StatusChangeLogFactory::repository()->findOneBy([
        ...
        $this->assertNotNull($purchaseOrderItemStatusChangeLog);
    }
}