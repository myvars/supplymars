...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[markup]' => 'Testing',
            'category[isActive]' => 'Testing',
            'category[owner]' => 'Testing',
            'category[vatRate]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'category[markup]' => 'Something New',
            'category[isActive]' => 'Something New',
            'category[owner]' => 'Something New',
            'category[vatRate]' => 'Something New',
        ]);
