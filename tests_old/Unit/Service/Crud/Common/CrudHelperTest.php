...
class CrudHelperTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->helper = new CrudHelper($this->requestStack, $this->twig, $this->router);
    }

    public function testSnakeCase(): void
    {
        $result = $this->helper->snakeCase('Test String');
    ...
    public function testGetRequest(): void
    {
        ...
        $result = $this->helper->getRequest();
        $this->assertSame($request, $result);
    }

    public function testGetRouter(): void
    {
        $result = $this->helper->getRouter();
    ...
    public function testShowEmpty(): void
    {
        ...
        $response = $this->helper->showEmpty('section');
