...
class SupplierUtilityTest extends TestCase
{
    ...
    public function testGetRandomSupplier(): void
    {
        ...
        $this->em->method('getRepository')->willReturn($this->createMock(SupplierDoctrineRepository::class));
        $this->em->getRepository(Supplier::class)->method('findAll')->willReturn([$supplier]);
