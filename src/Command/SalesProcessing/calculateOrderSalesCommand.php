...
class calculateOrderSalesCommand
{
    private const string DATE_FORMAT = 'Y-m-d';

    public function __construct(
        private readonly OrderSalesCalculator $orderSalesCalculator,
        private readonly calculateOrderSalesSummaryCommand $orderSalesSummaryCommand,
    ) {
    }
    ...
    public function runTheOrderSalesSummaryCommand(OutputInterface $output): void
    {
        ...
        $this->orderSalesSummaryCommand->__invoke($input, $output, null);
    }
}
