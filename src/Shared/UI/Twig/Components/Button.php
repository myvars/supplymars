...
final class Button
{
    ...
    public function getVariantClasses(): string
    {
        return match ($this->variant) {
            'primary' => 'px-4 text-white bg-blue-600 hover:bg-blue-500 shadow-sm hover:shadow-md focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:bg-blue-500 dark:hover:bg-blue-400 dark:focus-visible:ring-blue-400 dark:focus-visible:ring-offset-gray-900',
            'secondary' => 'px-4 text-white bg-gray-600 hover:bg-gray-500 shadow-sm hover:shadow-md focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 dark:bg-gray-500 dark:hover:bg-gray-400 dark:focus-visible:ring-gray-400 dark:focus-visible:ring-offset-gray-900',
            'alternative' => 'px-4 text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 hover:text-gray-900 shadow-sm hover:shadow-md focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gray-300 focus-visible:ring-offset-2 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:text-white dark:focus-visible:ring-gray-500 dark:focus-visible:ring-offset-gray-900',
