...
final class Button
{
    ...
    public function getVariantClasses(): string
    {
        return match ($this->variant) {
            ...
            'danger-outline' => 'px-4 text-red-600 bg-transparent border border-red-300 hover:bg-red-600 hover:text-white shadow-sm hover:shadow-md focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 dark:text-red-400 dark:border-red-500/50 dark:hover:bg-red-500 dark:hover:text-white dark:focus-visible:outline-red-400',
            ...
            'link' => 'text-gray-700 underline-offset-2 hover:text-gray-900 hover:underline focus-visible:outline-hidden focus-visible:underline dark:text-gray-400 dark:hover:text-white',
