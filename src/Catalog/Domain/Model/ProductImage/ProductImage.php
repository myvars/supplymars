...
namespace App\Catalog\Domain\Model\ProductImage;
...
#[ORM\Entity(repositoryClass: ProductImageDoctrineRepository::class)]
class ProductImage
{
    ...
    public function assignProduct(Product $product): static
    {
