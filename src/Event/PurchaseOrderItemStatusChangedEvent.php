...
class PurchaseOrderItemStatusChangedEvent extends DomainEvent
{
    public const DomainEventType EVENT_TYPE = DomainEventType::PURCHASE_ORDER_ITEM_STATUS_CHANGED;
