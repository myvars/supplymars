...
class SupplierProductController extends AbstractController
{
    ...
    #[Route(path: '/supplier-product/', name: 'app_supplier_product_index', methods: ['GET'])]
    ...
    #[Route(
        ...
        name: 'app_supplier_product_search_filter',
        methods: ['GET', 'POST'])
    ]
    ...
    #[Route(path: '/supplier-product/new', name: 'app_supplier_product_new', methods: ['GET', 'POST'])]
    ...
    #[Route(path: '/supplier-product/{id}', name: 'app_supplier_product_show', methods: ['GET'])]
    ...
    #[Route(path: '/supplier-product/{id}/edit', name: 'app_supplier_product_edit', methods: ['GET', 'POST'])]
    ...
    #[Route(
        ...
        name: 'app_supplier_product_delete_confirm',
        methods: ['GET']
    )]
    ...
    #[Route(path: '/supplier-product/{id}/delete', name: 'app_supplier_product_delete', methods: ['POST'])]
    ...
    #[Route(
        ...
        name: 'app_supplier_product_remove_confirm',
        methods: ['GET']
    )]
    ...
    #[Route(path: '/supplier-product/{id}/remove', name: 'app_supplier_product_remove', methods: ['POST'])]
    ...
    #[Route(
        ...
        name: 'app_supplier_product_toggle_status',
        methods: ['GET']
    )]
    ...
    #[Route(path: '/supplier-product/{id}/map', name: 'app_supplier_product_map', methods: ['GET'])]
    public function map(
        SupplierProduct $supplierProduct,
        CrudHandler $handler,
