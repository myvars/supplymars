...
class VatRateController extends AbstractController
{
    ...
    #[Route(path: '/vat-rate/', name: 'app_vat_rate_index', methods: ['GET'])]
    ...
    #[Route(path: '/vat-rate/new', name: 'app_vat_rate_new', methods: ['GET', 'POST'])]
    public function new(CrudCreator $handler): Response
    {
        return $handler->create(self::SECTION, new VatRate(), VatRateType::class);
    }

    #[Route(path: '/vat-rate/{id}', name: 'app_vat_rate_show', methods: ['GET'])]
    ...
    #[Route(path: '/vat-rate/{id}/edit', name: 'app_vat_rate_edit', methods: ['GET', 'POST'])]
    ...
    #[Route(path: '/vat-rate/{id}/delete/confirm', name: 'app_vat_rate_delete_confirm', methods: ['GET'])]
    ...
    #[Route(path: '/vat-rate/{id}/delete', name: 'app_vat_rate_delete', methods: ['POST'])]
