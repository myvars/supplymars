...
#[ORM\Entity(repositoryClass: CustomerSegmentSummaryDoctrineRepository::class)]
class CustomerSegmentSummary
{
    final private function __construct(
        #[ORM\Id]
        #[ORM\Column(length: 50)]
        #[Assert\NotBlank(message: 'Segment must not be blank')]
        private readonly CustomerSegment $segment,
        ...
        #[Assert\NotBlank(message: 'Average items per order must not be blank')]
        #[Assert\PositiveOrZero(message: 'Average items per order must be zero or positive')]
        private readonly string $averageItemsPerOrder,
    ...
    public function getAverageItemsPerOrder(): string
    {
