...
|-------|---------|-------|------|
| 1. Page background | Base canvas | `bg-gray-50` | `dark:bg-gray-950` |
| 2. Primary surface | Cards, panels | `bg-white` | `dark:bg-gray-800` |
| 3. Elevated surface | Modals, dialogs | `bg-white` | `dark:bg-gray-800` |
| 4. Inset / well | Subordinate content within cards | `bg-gray-50` | `dark:bg-gray-900/50` |
| 5. Header / footer accent | Card footers, section accents | `bg-gray-50` | `dark:bg-gray-700/50` |
| 6. Control surface | Sort bars, toolbars | `bg-gray-100` | `dark:bg-gray-800` |
...
| Sidebar border | `border-r border-gray-200 dark:border-gray-700` |
| Table row border | `border-b border-gray-200 dark:border-gray-700` |
...
- Modals and cards share Layer 2/3 (`bg-white` / `dark:bg-gray-800`). Depth is conveyed by the backdrop overlay and shadow, not background color difference.
